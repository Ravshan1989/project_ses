...
const DailyReportUnifiedPage: React.FC = () => {
    ...
    useEffect(() => {
        const handleKeyDown = (e: KeyboardEvent) => {
            ...
            // Date navigation (only when not in an input)
    ...
    const handleExcelExport = () => {
        const sections = [
            {
                title: t('unified_page.excel_titles.hepatitis'),
                sheetName: 'Gepatit',
                data: hepatitisData,
                columns: [
                    ...
                    { header: t('export_page.table_headers.age_30_plus'), key: 'age_20_plus', width: 10 },
                    { header: t('export_page.table_headers.lab_positive'), key: 'lab_positive', width: 10 },
                    { header: t('export_page.table_headers.status'), key: 'status', width: 15 },
                ]
            },
            {
                title: t('unified_page.excel_titles.flu'),
                sheetName: 'Gripp_ORVI',
                data: fluAriData,
                columns: [
                    { header: t('export_page.table_headers.region'), key: 'district_name', width: 25 },
                    { header: t('export_page.table_headers.ari_total'), key: 'ari_total', width: 12 },
                    { header: t('export_page.table_headers.flu_total'), key: 'flu_total', width: 12 },
                    { header: t('export_page.table_headers.pneu_total'), key: 'pneu_total', width: 12 },
                    { header: t('export_page.table_headers.sari_total'), key: 'sari_total', width: 12 },
                    { header: t('export_page.table_headers.death_total'), key: 'death_total', width: 12 },
                    { header: t('export_page.table_headers.status'), key: 'status', width: 15 },
                ]
            },
            {
                title: t('unified_page.excel_titles.covid'),
                sheetName: 'COVID',
                data: covidData,
                columns: [
                    { header: t('export_page.table_headers.region'), key: 'district_name', width: 25 },
                    { header: t('export_page.table_headers.total'), key: 'total_cases', width: 12 },
                    { header: t('export_page.table_headers.hospital_count'), key: 'hospitalized_count', width: 12 },
                    { header: t('export_page.table_headers.reinfected'), key: 'reinfected', width: 12 },
                    { header: t('export_page.table_headers.status'), key: 'status', width: 15 },
                ]
            },
            {
                title: t('unified_page.excel_titles.epidemiology'),
                sheetName: 'EPI',
                data: epiData,
                columns: [
                    { header: t('export_page.table_headers.region'), key: 'district_name', width: 25 },
