...
const FluAriTab: React.FC<FluAriTabProps> = ({ data, loading, isAdmin, onChange, onVerify, onApprove }) => {
    ...
    const columns: any = [
        ...
        },
        {
            ...
            children: [
                { title: t('export_page.table_headers.total') || 'Jami', width: 65, render: (_: any, r: any) => renderInput(r, 'ari_total', true) },
                { title: t('daily_reports.tabs.common.age_0_1'), width: 60, render: (_: any, r: any) => renderInput(r, 'ari_0_1') },
                { title: t('daily_reports.tabs.common.age_1_2'), width: 60, render: (_: any, r: any) => renderInput(r, 'ari_1_2') },
                { title: t('daily_reports.tabs.common.age_3_6'), width: 60, render: (_: any, r: any) => renderInput(r, 'ari_3_6') },
                { title: t('daily_reports.tabs.common.age_7_14'), width: 65, render: (_: any, r: any) => renderInput(r, 'ari_7_14') },
                { title: t('daily_reports.tabs.flu.adults'), width: 70, render: (_: any, r: any) => renderInput(r, 'ari_adult') },
            ]
        },
        {
            title: t('daily_reports.tabs.flu.pneu_title'),
            children: [
                { title: t('export_page.table_headers.total') || 'Jami', width: 65, render: (_: any, r: any) => renderInput(r, 'pneu_total', true) },
                { title: t('daily_reports.tabs.common.age_0_2'), width: 60, render: (_: any, r: any) => renderInput(r, 'pneu_0_2') },
                { title: t('daily_reports.tabs.common.age_3_6'), width: 60, render: (_: any, r: any) => renderInput(r, 'pneu_3_6') },
                { title: t('daily_reports.tabs.common.age_7_14'), width: 65, render: (_: any, r: any) => renderInput(r, 'pneu_7_14') },
                { title: t('daily_reports.tabs.flu.adults'), width: 70, render: (_: any, r: any) => renderInput(r, 'pneu_adult') },
            ]
        },
        {
            title: t('daily_reports.tabs.flu.gk_title'),
            children: [
                { title: t('export_page.table_headers.total') || 'Jami', width: 65, render: (_: any, r: any) => renderInput(r, 'flu_total', true) },
                { title: t('daily_reports.tabs.common.age_0_1'), width: 60, render: (_: any, r: any) => renderInput(r, 'flu_0_1') },
                { title: t('daily_reports.tabs.common.age_1_2'), width: 60, render: (_: any, r: any) => renderInput(r, 'flu_1_2') },
                { title: t('daily_reports.tabs.common.age_3_6'), width: 60, render: (_: any, r: any) => renderInput(r, 'flu_3_6') },
                { title: t('daily_reports.tabs.common.age_7_14'), width: 65, render: (_: any, r: any) => renderInput(r, 'flu_7_14') },
                { title: t('daily_reports.tabs.flu.adults'), width: 70, render: (_: any, r: any) => renderInput(r, 'flu_adult') },
            ]
        },
        {
            title: t('daily_reports.tabs.flu.sari_title'),
            children: [
                { title: t('export_page.table_headers.total') || 'Jami', width: 65, render: (_: any, r: any) => renderInput(r, 'sari_total', true) },
                { title: t('daily_reports.tabs.common.age_0_2'), width: 60, render: (_: any, r: any) => renderInput(r, 'sari_0_2') },
                { title: t('daily_reports.tabs.common.age_3_6'), width: 60, render: (_: any, r: any) => renderInput(r, 'sari_3_6') },
                { title: t('daily_reports.tabs.common.age_7_14'), width: 65, render: (_: any, r: any) => renderInput(r, 'sari_7_14') },
                { title: t('daily_reports.tabs.flu.adults'), width: 70, render: (_: any, r: any) => renderInput(r, 'sari_adult') },
            ]
        },
        {
            title: t('daily_reports.tabs.flu.deaths_title'),
            children: [
                { title: t('export_page.table_headers.total') || 'Jami', width: 65, render: (_: any, r: any) => renderInput(r, 'death_total') },
                { title: t('daily_reports.tabs.flu.pregnant'), width: 90, render: (_: any, r: any) => renderInput(r, 'death_pregnant') },
            ]
        },
        {
