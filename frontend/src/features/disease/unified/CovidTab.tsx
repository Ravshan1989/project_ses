...
const CovidTab: React.FC<CovidTabProps> = ({ data, loading, userRole, onChange, onVerify, onApprove, onReject, onSubmit }) => {
    ...
    const renderInput = (record: CovidReportData, field: keyof CovidReportData, forceReadOnly = false) => {
    ...
    const columns: any = [
        ...
        { title: t('export_page.table_headers.total') || 'Jami', width: 70, render: (_: any, r: any) => renderInput(r, 'total_cases') },
        { title: t('daily_reports.tabs.covid.reinfected'), width: 90, render: (_: any, r: any) => renderInput(r, 'reinfected') },
        { title: t('daily_reports.tabs.covid.vaccinated_infected'), width: 90, render: (_: any, r: any) => renderInput(r, 'vaccinated_infected') },
        {
            title: t('daily_reports.hepatitis_age_groups') || 'Yosh toifalari',
            children: [
                { title: t('daily_reports.tabs.common.age_0_1'), width: 60, render: (_: any, r: any) => renderInput(r, 'age_0_1') },
                ...
                { title: t('daily_reports.tabs.common.age_20_29'), width: 70, render: (_: any, r: any) => renderInput(r, 'age_20_29') },
                { title: t('daily_reports.tabs.common.age_30_39'), width: 70, render: (_: any, r: any) => renderInput(r, 'age_30_39') },
                { title: t('daily_reports.tabs.common.age_40_49'), width: 70, render: (_: any, r: any) => renderInput(r, 'age_40_49') },
                { title: t('daily_reports.tabs.common.age_50_59'), width: 70, render: (_: any, r: any) => renderInput(r, 'age_50_59') },
                { title: t('daily_reports.tabs.common.age_60_plus'), width: 70, render: (_: any, r: any) => renderInput(r, 'age_60_plus') },
            ]
        },
        {
            title: t('daily_reports.tabs.covid.groups'),
            children: [
                { title: t('daily_reports.tabs.covid.pre_school_unorganized'), width: 120, render: (_: any, r: any) => renderInput(r, 'pre_school_organized') },
                { title: t('daily_reports.tabs.covid.pre_school_organized'), width: 120, render: (_: any, r: any) => renderInput(r, 'pre_school_unorganized') },
                { title: t('daily_reports.tabs.covid.students'), width: 120, render: (_: any, r: any) => renderInput(r, 'students') },
                { title: t('daily_reports.tabs.covid.medical_workers'), width: 120, render: (_: any, r: any) => renderInput(r, 'medical_workers') },
                { title: t('daily_reports.tabs.covid.teachers'), width: 100, render: (_: any, r: any) => renderInput(r, 'teachers') },
                { title: t('daily_reports.tabs.covid.others'), width: 110, render: (_: any, r: any) => renderInput(r, 'others') },
            ]
        },
        { title: t('daily_reports.tabs.covid.hospitalized_count'), width: 120, render: (_: any, r: any) => renderInput(r, 'hospitalized_count') },
        {
