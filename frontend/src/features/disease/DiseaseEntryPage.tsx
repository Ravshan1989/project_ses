...
const DISTRICTS = [
    ...
    'Ohangaron shahri', 'YangiyoвЂl shahri', 'OqqoвЂrgвЂon tumani', 'Ohangaron tumani', 'Bekobod tumani',
    'BoвЂstonliq tumani', 'BoвЂka tumani', 'Quyi Chirchiq tumani', 'Zangiota tumani', 'Yuqori Chirchiq tumani',
    'Qibray tumani', 'Parkent tumani', 'Piskent tumani', 'OвЂrta Chirchiq tumani', 'Chinoz tumani',
    'YangiyoвЂl tumani', 'Toshkent tumani'
];
...
// const DISTRICTS = [
//     'Nurafshon shahri', 'Angren shahri', 'Bekobod shahri', 'Chirchiq shahri', 'Olmaliq shahri',
//     'Ohangaron shahri', 'YangiyoтАШl shahri', 'OqqoтАШrgтАШon tumani', 'Ohangaron tumani', 'Bekobod tumani',
//     'BoтАШstonliq tumani', 'BoтАШka tumani', 'Quyi Chirchiq tumani', 'Zangiota tumani', 'Yuqori Chirchiq tumani',
//     'Qibray tumani', 'Parkent tumani', 'Piskent tumani', 'OтАШrta Chirchiq tumani', 'Chinoz tumani',
//     'YangiyoтАШl tumani', 'Toshkent tumani'
// ];
// 
// const DiseaseEntryPage: React.FC = () => {
//     const [form] = Form.useForm();
