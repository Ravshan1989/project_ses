...
async function bootstrap() {
    ...
    const permRepo: Repository<Permission> = app.get(getRepositoryToken(Permission));
    const deptPermRepo: Repository<DepartmentPermission> = app.get(getRepositoryToken(DepartmentPermission));
    ...
    const assignments = [
        { dept: "Epidemiologiya Bo'limi", perms: ["VIEW_EPIDEMIOLOGY", "VIEW_WEEKLY_SUMMARY"] },
        { dept: "VGA Bo'limi", perms: ["VIEW_HEPATITIS"] },
        { dept: "O'RI va Gripp Bo'limi", perms: ["VIEW_FLU"] },
        {
            dept: "Boshqaruv (Admin)", perms: [
                "VIEW_HEPATITIS", "VIEW_FLU", "VIEW_EPIDEMIOLOGY", "VIEW_WEEKLY_SUMMARY", "VIEW_COVID",
                "VIEW_FORM1_TABLE1", "VIEW_FORM1_TABLE2", "VIEW_FORM1_TABLE3", "EDIT_FORM1_TABLE1",
                "MANAGE_DEPARTMENTS"
            ]
        },
        ...
        {
            dept: "Epidemiologiya va immunoprofilaktika", perms: [
                "VIEW_FORM1_TABLE1", "EDIT_FORM1_TABLE1",
                "VIEW_HEPATITIS", "VIEW_FLU", "VIEW_EPIDEMIOLOGY", "VIEW_WEEKLY_SUMMARY", "VIEW_COVID"
            ]
        },
    ];
