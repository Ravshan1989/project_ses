...
export class InspectionsController {
  ...
  updateRecord(
    @Param("id") id: string,
    @Body() dto: UpdateInspectionRecordDto,
  ) {
  ...
  @Post("table2")
  saveTable2(
    @Body() body: { month: string; organizationId: string; rows: any[] },
  ) {
    return this.inspectionsService.saveTable2Data(
      body.month,
      body.organizationId,
      body.rows,
    );
  ...
  saveTable3(
    ...
    return this.inspectionsService.saveTable3Data(
      body.month,
      body.organizationId,
      body.rows,
    );
  ...
  saveTable4(
    ...
    return this.inspectionsService.saveTable4Data(
      body.month,
      body.organizationId,
      body.rows,
    );
