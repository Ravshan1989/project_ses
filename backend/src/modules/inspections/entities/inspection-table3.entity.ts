...
/**
 * Хабардор этиш тартибида ўтказилган текширишлар натижасида
 * тадбиркорлик субъектларга нисбатан қўлланилган таъсир чоралари
 * (Nazoratlarni muvofiqlashtirish - Jadval 3)
 */
@Entity("inspection_table3")
@Unique(["organization_id", "period_month", "row_key"])
export class InspectionTable3 {
    ...
    /** Хабардор этиш тартибида ўтказилган текширишлар */
