...
export class KgWaterReport {
  ...
  chem_bad_ammiak: number;
  @Column({ type: "decimal", precision: 10, scale: 2, default: 0 })
  chem_bad_nitrat: number;
  @Column({ type: "decimal", precision: 10, scale: 2, default: 0 })
  chem_bad_nitrit: number;
  @Column({ type: "decimal", precision: 10, scale: 2, default: 0 })
  chem_bad_qoldiq: number; // Quruq qoldiq
  @Column({ type: "decimal", precision: 10, scale: 2, default: 0 })
  chem_bad_xlorid: number;
  @Column({ type: "decimal", precision: 10, scale: 2, default: 0 })
  chem_bad_sulfat: number;
  @Column({ type: "decimal", precision: 10, scale: 2, default: 0 })
  chem_bad_loyqa: number; // Loyqalanish
  @Column({ type: "decimal", precision: 10, scale: 2, default: 0 })
  chem_bad_qattiq: number; // Um. qattiqlik
  @Column({ type: "decimal", precision: 10, scale: 2, default: 0 })
  chem_bad_other: number;
