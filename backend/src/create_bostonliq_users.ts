...
async function bootstrap() {
    ...
    const usersToCreate = [
        { username: 'bostonliq_head', role: UserRole.DISTRICT_HEAD, firstName: 'Bo\'stonliq', lastName: 'Boshlig\'i' },
        { username: 'bostonliq_chief', role: UserRole.DEPARTMENT_HEAD, firstName: 'Bo\'stonliq', lastName: 'Mudiri' },
        { username: 'bostonliq_staff1', role: UserRole.STAFF, firstName: 'Xodim', lastName: '1' },
        { username: 'bostonliq_staff2', role: UserRole.STAFF, firstName: 'Xodim', lastName: '2' },
        { username: 'bostonliq_staff3', role: UserRole.STAFF, firstName: 'Xodim', lastName: '3' },
    ];
