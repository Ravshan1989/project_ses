...
const DISEASES_MAPPING = {
    ...
    "Ичбуруғ бактерия ташувчилари": "Ichburug' baktoriyah tashuvchilari",
    ...
    "Қўзғатувчилари аниқланмаган ва аниқ белгиланмаган ўткир ичак инфекциялари va овқат токсикоинфекциялари": "Qo'zg'atuvchilari aniqlanmagan va aniq belgilanmagan o'tkir ichak infeksiyalari va ovqat toksikoinfeksiyalari",
    ...
    "шу жумлаdan гепатит А": "shu jumladan gepatit A",
    "гепатит В": "gepatit B",
    "гепатит С": "gepatit C",
    "гепатит Е": "gepatit E",
    "гепатит Д": "gepatit D",
    "Гепатит вирусини ташувчиlar – биринчи марта аниқланганлар – жами": "Gepatit virusini tashuvchilar – birinchi marta aniqlanganlar – jami",
    ...
    "шу жумлаdan, эпидемия тошмали терлама": "shu jumladan, epidemiya toshmali terlama",
    ...
    "Туққан аёллардаги йирингли септик касалликлар: сепсис, мастит, акушерлик ярасининг жарроҳлик амалиётиdan keyingi infeksiyasi, tug'ruqdan keyingi yoyilgan infeksiya va boshqalar": "Tuqqan ayollardagi yiringli septik kasalliklar: sepsis, mastit, akusherlik yarasining jarrohlik amaliyotidan keyingi infeksiyasi, tug'ruqdan keyingi yoyilgan infeksiya va boshqalar",
    "Операциядан кейинги инфекциялар: сепсис, абцесс, флегмона, инъекцияdan keyingi sepsis, infuziyalar, perfuziyalar, transfuziyalar oqibatida yuz beradigan sepsis": "Operatsiyadan keyingi infeksiyalar: sepsis, abstsess, flegmona, inyeksiyadan keyingi sepsis, infuziyalar, perfuziyalar, transfuziyalar oqibatida yuz beradigan sepsis",
    ...
    "Аниқланган ва аниқланмаган қўзғатувчилар сабаб бўлган ўткир ичак инфекциялари: энтеритлар, колитлар, гоастроэнтеритlar, enterokolitlar": "Aniqlangan va aniqlanmagan qo'zg'atuvchilar sabab bo'lgan o'tkir ichak infeksiyalari: enteritlar, colitlar, gastroenteritlar, enterokolitlar",
...
async function run() {
    ...
    const client = new Client({
        ...
        host: 'localhost',
        database: 'regionstat',
        password: 'postgres', // Correct local password
        port: 5432
    });
    ...
    try {
        ...
        console.log('Local diseases updated.');
